const RecentActivityCard = ({ pedidos, username }) => {
  return (
    <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
      <h4 className="font-medium text-gray-700 dark:text-gray-200 mb-3">{username}</h4>
        ...
        {pedidos.map((pedido, index) => (
          <div key={index} className="border-l-4 pl-3 py-1" style={{
            ...
            <div className="flex justify-between items-center text-sm">
              <span className="text-gray-600 dark:text-gray-200">{new Date(pedido.fecha).toLocaleDateString()}</span>
