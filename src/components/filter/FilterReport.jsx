      ...
      <div className="flex flex-col md:flex-row md:items-end md:gap-4 w-full">
        <div className="flex flex-col w-full md:w-40">
          ...
          <select
            ...
            className="border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400"
          >
